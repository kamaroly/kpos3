 ...
 * @copyright	Copyright (c) 2014 EllisLab, Inc. (http://ellislab.com/)
...
class LaraCart {
	...
	public function __construct($params = array())
	{
		...
		if ($this->_cartContent === NULL)
		{
			...
			$this->_cartContent = array('cartTotal' => 0, 'total_items' => 0);
		}
	...
	protected function _save_cart()
	{
		...
		$this->_cartContent['total_items'] = $this->_cartContent['cartTotal'] = 0;
	...
	{
		return (in_array($row_id, array('total_items', 'cartTotal'), TRUE) OR ! isset($this->_cartContent[$row_id]))
			? FALSE
