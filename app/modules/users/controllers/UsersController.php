...
use App\Modules\Users\Controllers\PermissionsController as PermissionsController;
...
class UsersController extends PermissionsController{
	...
	public function getCreate()
	{
		...
		// Show the page
		return View::make('users::create', compact('groups', 'selectedGroups', 'permissions', 'selectedPermissions'));
	}
	...
	public function postEdit($id = null)
	{
		...
		try
		{
			...
			if ($user->save())
			{
				...
				return Redirect::route('users/'.$id.'/edit')->with('success', $success);
			}
